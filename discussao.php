<?php
	...
	require_once 'Classes/Comentario.php';
    	$cmt = new Comentario("projeto_comentarios", "localhost", "root", "senha");
...
<body>
    ...
    <div id="largura-pagina">
		...
		<form method="POST">
      		    ...
      		    <textarea name="texto" id="" cols="30" rows="10" placeholder="Participe da discussão" maxlength="400"></textarea>
